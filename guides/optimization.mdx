...
- [API Reference](/api/optimize) - Complete Optimize API documentation
- [Solver](/api/solver) - Standard constraint solving
- [Tactics](/api/tactics) - Simplification and preprocessing strategies
